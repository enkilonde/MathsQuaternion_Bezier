...
void bezierSurface::calSurface(){
    ...
    for (int ui = 0; ui <= precision; ui++) {
        ...
        for (int vi = 0; vi <= precision; vi++) {
            ...
            vertices.push_back(curvePoints[ui][vi][0]);
            vertices.push_back(curvePoints[ui][vi][1]);
            vertices.push_back(curvePoints[ui][vi][2]);

            curveIndexes.push_back(n + 0);
            curveIndexes.push_back(n + 1);
            curveIndexes.push_back(n + 2);
            n++;
